...
const Navbar = () => {
  ...
  return (
    <>
      {/* Desktop Navbar */}
      <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-white/20 text-white px-4 md:px-12 py-6 flex justify-between items-center transition duration-300">
        {/* Logo */}
        <img
          src={techno2025logo}
          alt="technologo"
